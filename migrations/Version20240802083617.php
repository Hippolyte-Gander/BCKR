 ...
 */
final class Version20240802083617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD CONSTRAINT FK_B26681EA5F2C6E2 FOREIGN KEY (cree_id) REFERENCES user (id)');
