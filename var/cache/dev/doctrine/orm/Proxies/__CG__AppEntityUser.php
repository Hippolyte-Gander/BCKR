...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'participationsEvenement' => [parent::class, 'participationsEvenement', null],
        "\0".parent::class."\0".'password' => [parent::class, 'password', null],
        "\0".parent::class."\0".'photoProfil' => [parent::class, 'photoProfil', null],
        ...
        'participationsEvenement' => [parent::class, 'participationsEvenement', null],
        'password' => [parent::class, 'password', null],
        'photoProfil' => [parent::class, 'photoProfil', null],
