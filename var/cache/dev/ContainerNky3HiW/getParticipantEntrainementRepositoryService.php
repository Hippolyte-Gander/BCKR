 ...
 */
class getParticipantEntrainementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipantEntrainementRepository' shared autowired service.
     *
     * @return \App\Repository\ParticipantEntrainementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipantEntrainementRepository.php';

        return $container->privates['App\\Repository\\ParticipantEntrainementRepository'] = new \App\Repository\ParticipantEntrainementRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
