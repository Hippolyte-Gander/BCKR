...
class __TwigTemplate_c7961767bc4880d67b8d038ee36b1ca6 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        yield "<h1>Activation de votre compte sur le site du BCKR</h1>
<p>Bonjour ";
        // line 2
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 2, $this->source); })()), "pseudo", [], "any", false, false, false, 2), "html", null, true);
        yield ",</p>
...
<p>Merci</p>";
    ...
    {
        return new Source("<h1>Activation de votre compte sur le site du BCKR</h1>
<p>Bonjour {{ user.pseudo }},</p>
<p>Pour activer votre compte sur le site du BCKR cliquez sur le lien ci-dessous.</p>
<p><a href=\"{{ absolute_url(path('verify_user', {token: token})) }}\">Lien</a></p>
<p>Merci</p>", "emails/register.html.twig", "C:\\laragon\\www\\hippolyte G\\Github\\BCKR\\templates\\emails\\register.html.twig");
    }
}
