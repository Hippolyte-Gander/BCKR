...
class __TwigTemplate_f9c6a0ba5cac96642ef3290fc8865d63 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <p>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
                // line 20
                yield "                <a class=\"texte-utilisateur\" href=\" ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("show_user", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 20)]), "html", null, true);
                yield " \">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "pseudo", [], "any", false, false, false, 20), "html", null, true);
                yield "</a>
            ";
            }
...
";
    ...
    {
        return array (  139 => 30,  133 => 26,  127 => 22,  116 => 20,  112 => 19,  105 => 14,  103 => 13,  100 => 12,  90 => 11,  77 => 7,  73 => 5,  70 => 4,  60 => 3,  37 => 1,);
    }
...
{% if app.user  and app.user.isAdmin() %}
    <div class=\"utilisateurs-container\">
        ...
        <p>
            {% for user in users %}
                <a class=\"texte-utilisateur\" href=\" {{ path('show_user', {'id': user.id}) }} \">{{ user.pseudo }}</a>
            {% endfor %}
        </p>
