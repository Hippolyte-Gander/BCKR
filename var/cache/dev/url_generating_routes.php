...
return [
    ...
    'suppr_commentaire' => [['id'], ['_controller' => 'App\\Controller\\EvenementController::supprCommentaire'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/commentaire']], [], [], []],
    ...
    'show_membre' => [['id'], ['_controller' => 'App\\Controller\\MembreController::show'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id', true], ['text', '/membre']], [], [], []],
    'new_membre' => [[], ['_controller' => 'App\\Controller\\MembreController::new_editMembre'], [], [['text', '/membre/new']], [], [], []],
    'edit_membre' => [['id'], ['_controller' => 'App\\Controller\\MembreController::new_editMembre'], ['id' => '\\d+'], [['text', '/edit'], ['variable', '/', '\\d+', 'id', true], ['text', '/membre']], [], [], []],
    'suppr_membre' => [['id'], ['_controller' => 'App\\Controller\\MembreController::supprMembre'], [], [['text', '/suppr'], ['variable', '/', '[^/]++', 'id', true], ['text', '/membre']], [], [], []],
    ...
    'App\Controller\EvenementController::supprCommentaire' => [['id'], ['_controller' => 'App\\Controller\\EvenementController::supprCommentaire'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/commentaire']], [], [], []],
    ...
    'App\Controller\MembreController::show' => [['id'], ['_controller' => 'App\\Controller\\MembreController::show'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id', true], ['text', '/membre']], [], [], []],
    'App\Controller\MembreController::supprMembre' => [['id'], ['_controller' => 'App\\Controller\\MembreController::supprMembre'], [], [['text', '/suppr'], ['variable', '/', '[^/]++', 'id', true], ['text', '/membre']], [], [], []],
